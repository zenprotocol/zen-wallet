...
namespace Wallet
{
	public partial class WalletSendLayout
	{
		...
		protected virtual void Build()
		{
			...
			global::Gtk.Box.BoxChild w6 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.entryDestination]));
			w6.Position = 0;
			w6.Padding = ((uint)(10));
			// Container child hbox1.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w7 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.buttonPaste]));
			w7.Position = 1;
			w7.Expand = false;
			w7.Fill = false;
			this.vboxDestination.Add(this.hbox1);
			global::Gtk.Box.BoxChild w8 = ((global::Gtk.Box.BoxChild)(this.vboxDestination[this.hbox1]));
			w8.Position = 1;
			w8.Expand = false;
			w8.Fill = false;
			this.eventboxDestination.Add(this.vboxDestination);
			this.vboxMainInner.Add(this.eventboxDestination);
			global::Gtk.Box.BoxChild w10 = ((global::Gtk.Box.BoxChild)(this.vboxMainInner[this.eventboxDestination]));
			w10.Position = 0;
			w10.Expand = false;
			w10.Fill = false;
			w10.Padding = ((uint)(5));
			...
			global::Gtk.Box.BoxChild w11 = ((global::Gtk.Box.BoxChild)(this.hbox3[this.labelAsset]));
			w11.Position = 0;
			w11.Expand = false;
			w11.Fill = false;
			w11.Padding = ((uint)(10));
			this.vboxDestination1.Add(this.hbox3);
			global::Gtk.Box.BoxChild w12 = ((global::Gtk.Box.BoxChild)(this.vboxDestination1[this.hbox3]));
			w12.Position = 0;
			w12.Expand = false;
			w12.Fill = false;
			// Container child vboxDestination1.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w13 = ((global::Gtk.Box.BoxChild)(this.hbox7[this.imageAsset]));
			w13.Position = 0;
			w13.Expand = false;
			w13.Fill = false;
			// Container child hbox7.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w14 = ((global::Gtk.Box.BoxChild)(this.hbox7[this.labelSelectedAsset]));
			w14.Position = 1;
			w14.Expand = false;
			w14.Fill = false;
			this.eventbox6.Add(this.hbox7);
			this.hboxAsset.Add(this.eventbox6);
			global::Gtk.Box.BoxChild w16 = ((global::Gtk.Box.BoxChild)(this.hboxAsset[this.eventbox6]));
			w16.Position = 0;
			w16.Expand = false;
			w16.Fill = false;
			// Container child hboxAsset.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w17 = ((global::Gtk.Box.BoxChild)(this.hboxAsset[this.labelSelectOtherAsset]));
			w17.Position = 1;
			w17.Expand = false;
			w17.Fill = false;
			w17.Padding = ((uint)(10));
			...
			global::Gtk.Box.BoxChild w18 = ((global::Gtk.Box.BoxChild)(this.hboxAsset[this.comboboxAsset]));
			w18.Position = 2;
			w18.Expand = false;
			w18.Fill = false;
			w18.Padding = ((uint)(10));
			this.vboxDestination1.Add(this.hboxAsset);
			global::Gtk.Box.BoxChild w19 = ((global::Gtk.Box.BoxChild)(this.vboxDestination1[this.hboxAsset]));
			w19.Position = 1;
			w19.Expand = false;
			w19.Fill = false;
			this.eventboxAsset.Add(this.vboxDestination1);
			this.vboxMainInner.Add(this.eventboxAsset);
			global::Gtk.Box.BoxChild w21 = ((global::Gtk.Box.BoxChild)(this.vboxMainInner[this.eventboxAsset]));
			w21.Position = 1;
			w21.Expand = false;
			w21.Fill = false;
			// Container child vboxMainInner.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w22 = ((global::Gtk.Box.BoxChild)(this.hbox6[this.labelAmount]));
			w22.Position = 0;
			w22.Expand = false;
			w22.Fill = false;
			w22.Padding = ((uint)(10));
			...
			global::Gtk.Box.BoxChild w23 = ((global::Gtk.Box.BoxChild)(this.hbox6[this.spinbuttonAmount]));
			w23.Position = 1;
			w23.Expand = false;
			w23.Fill = false;
			// Container child hbox6.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w24 = ((global::Gtk.Box.BoxChild)(this.hbox6[this.labelSelectedAsset1]));
			w24.Position = 2;
			w24.Expand = false;
			w24.Fill = false;
			...
			global::Gtk.Box.BoxChild w26 = ((global::Gtk.Box.BoxChild)(this.hbox8[this.labelBalance]));
			w26.Position = 0;
			w26.Expand = false;
			w26.Fill = false;
			w26.Padding = ((uint)(10));
			...
			global::Gtk.Box.BoxChild w27 = ((global::Gtk.Box.BoxChild)(this.hbox8[this.labelBalanceValue]));
			w27.Position = 1;
			w27.Expand = false;
			w27.Fill = false;
			...
			global::Gtk.Box.BoxChild w30 = ((global::Gtk.Box.BoxChild)(this.vboxMainInner[this.eventboxAmount]));
			w30.Position = 2;
			w30.Expand = false;
			w30.Fill = false;
			w30.Padding = ((uint)(5));
			...
			global::Gtk.Box.BoxChild w31 = ((global::Gtk.Box.BoxChild)(this.hbox4[this.buttonSignAndReview]));
			w31.Position = 1;
			w31.Expand = false;
			w31.Fill = false;
			this.vboxMainInner.Add(this.hbox4);
			global::Gtk.Box.BoxChild w32 = ((global::Gtk.Box.BoxChild)(this.vboxMainInner[this.hbox4]));
			w32.PackType = ((global::Gtk.PackType)(1));
			w32.Position = 3;
			w32.Expand = false;
			w32.Fill = false;
			this.vbox3.Add(this.vboxMainInner);
			global::Gtk.Box.BoxChild w33 = ((global::Gtk.Box.BoxChild)(this.vbox3[this.vboxMainInner]));
			w33.Position = 1;
			w33.Expand = false;
			w33.Fill = false;
			this.Add(this.vbox3);
