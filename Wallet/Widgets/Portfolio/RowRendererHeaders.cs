...
namespace Wallet
{
	public class RowRendererHeaders : CellRenderer
	{
		...
		//		rendererHelper.Image(ImagesCache.Instance.GetIcon(asset.Image), 50, 10);
            ...
            textRenderer.RenderLayoutText(context, "AMOUNT", 0, TEXT_PADDING + exposeArea.Y, exposeArea.Width, 20, Constants.Colors.TextBlue, Pango.Alignment.Right, Pango.EllipsizeMode.End, -TEXT_PADDING_LEFT);
