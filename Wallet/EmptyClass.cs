...
class CairoSample : DrawingArea
{
	static void Main_ ()
	{
		...
		global::Stetic.BinContainer.Attach (win);


		VBox vbox1 = new global::Gtk.VBox ();
		vbox1.Name = "vbox1";
		vbox1.Spacing = 20;
		vbox1.BorderWidth = ((uint)(15));
		win.Add (vbox1);
