...
namespace ContractsDiscovery.Web.Controllers
{
	public class OracleDataController : Controller
	{
		...
		public ActionResult Display(string id)
		{
            ...
            var commitmentDataMap = (FSharpMap<string, Tuple<Tuple<byte[], uint, byte[][]>, byte[]>>)ContractExamples.Oracle.proofMapSerializer.ReadObject(System.IO.File.OpenRead(file));
