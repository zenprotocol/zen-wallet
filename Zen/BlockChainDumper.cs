	...
	public class BlockChainDumper
	{
		...
		public void Populate()
		{
			...
			if (tip != null)
			{
				...
				while (bk != null)
				{
					var graphNode = new GraphNode(tip.Key.SequenceEqual(bkHash) ? GraphNodeTypeEnum.Genesis : GraphNodeTypeEnum.Block);
		...
		void AddTx(byte[] txHash, Consensus.Types.Transaction tx, TxStateEnum txState)
		{
			...
			foreach (var output in tx.outputs)
			{
				...
				Add(outputHash, new GraphNode(GraphNodeTypeEnum.Output, (output.spend.amount / Math.Pow(10,8)).ToString()), txHash);
				...
				Link(outpointHash, outputHash);
			}

			foreach (var outpoint in tx.inputs)
			{
				Add(Consensus.Merkle.outpointHasher.Invoke(outpoint), new GraphNode(GraphNodeTypeEnum.Input), txHash);
			}
		}
		...
		//void Link(byte[] ref1, GraphNode ref2)
		//{
		//	_Graph.GraphLinks.Add(new GraphLink()
		//	{
		//		GraphNode1 = _Keys[ref1],
		//		GraphNode2 = ref2
		//	});
		//}

		//void Link(GraphNode ref1, GraphNode ref2)
		//{
		//	_Graph.GraphLinks.Add(new GraphLink()
		//	{
		//		GraphNode1 = ref1,
		...
		//void LinkInner(GraphLink graphLink)
		//{
		//	foreach (var _graphLink in _Graph.GraphLinks)
		//	{
		//		if (_graphLink.GraphNode1 
		//	}
		//}
