...
namespace BlockChain.Tests
{
	...
	public class BlockChainTransactionRelocationTests : BlockChainTestsBase
	{
		...
		public new void OneTimeSetUp()
		{
			...
			block1 = _GenesisBlock.Value.Child().AddTx(block1_tx);
			block2 = _GenesisBlock.Value.Child().AddTx(block2_tx);
			block3 = _GenesisBlock.Value.Child().AddTx(block3_tx);
			block4 = _GenesisBlock.Value.Child().AddTx(block4_tx);
			block5 = _GenesisBlock.Value.Child().AddTx(block5_tx);
		}
